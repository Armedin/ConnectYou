...
<body class="landing_page">
  ...
  <section class="home_section">
    <div class="info">
      <h1>WE ARE CREATING A NEW REALITY </h1>
      <p>A reality where everyone has like minded people around them! No one is alone! Everyone has other people around them!
        We are people helping each other to be included into the community, feel safe, and be who we are.
      </p>
    </div>
    <div class="banner_img">
      <img src="dist/img/landing_1.png">
    </div>
    <div class="info">
      <h1>We value each and every user </h1>
      <p>We value each and every user of our network! Everyone is unique and special! You can create your own community with people who are
        similar to you on ConnectYou! Or who you play on FunConnect! Or who you meet on ActiveConnect!
      </p>
    </div>
    <div class="end_text">
      <p>Stay Connected! Stay You! </p>
    </div>
  </section>
